...
public class Sing_In {
    ...
    public void sing_In() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText3),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("cindy@jhu.edu"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText2),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("123321124312"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView2), withText("CINDY"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("CINDY")));


        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView3), withText("cindy@jhu.edu"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.navigation_header_container),
                                        0),
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("cindy@jhu.edu")));
